...
public class ContractInfoDAO {
    ...
    private String propertyChangeCalculate;

    private String feeChangeCalculate;
    ...
    public String getPropertyChangeCalculate() {
        return propertyChangeCalculate;
    }

    public void setPropertyChangeCalculate(String propertyChangeCalculate) {
        this.propertyChangeCalculate = propertyChangeCalculate == null ? null : propertyChangeCalculate.trim();
    }

    public String getFeeChangeCalculate() {
        return feeChangeCalculate;
    }

    public void setFeeChangeCalculate(String feeChangeCalculate) {
        this.feeChangeCalculate = feeChangeCalculate == null ? null : feeChangeCalculate.trim();
    }
}