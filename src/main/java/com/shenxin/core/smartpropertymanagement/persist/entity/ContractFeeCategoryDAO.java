...
public class ContractFeeCategoryDAO {
    ...
    private BigDecimal feeChangePeriod;
    ...
    public BigDecimal getFeeChangePeriod() {
        return feeChangePeriod;
    }

    public void setFeeChangePeriod(BigDecimal feeChangePeriod) {
        this.feeChangePeriod = feeChangePeriod;
    }
