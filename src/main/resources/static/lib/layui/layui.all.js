...
function getDataValue(data,dic){
    data = data[dic.dataName];
    if(dic.dataSecName){
        data = data[dic.dataSecName];
    }
    return data;
}

function setDataValue(data,dic,dataNew){

  if(dic.dataSecName){
      if(data[dic.dataName] == undefined){
          data[dic.dataName] = {};
      }
      data[dic.dataName][dic.dataSecName] = dataNew;
  }else{
      data[dic.dataName] = dataNew;
  }
}
...
layui.define(function(e) {
    ...
    u.prototype.type = function() { var e = this.config; if ("object" == typeof e.elem) return void 0 === e.elem.length ? 2 : 3 }, u.prototype.view = function() {
        ...
        a.layout = "object" == typeof a.layout ? a.layout : ["prev", "page", "next"], a.count = 0 | a.count, a.curr = 0 | a.curr || 1, a.limits = "object" == typeof a.limits ? a.limits : [10,50,100], a.limit = 0 | a.limit || 10, a.pages = Math.ceil(a.count / a.limit) || 1, a.curr > a.pages && (a.curr = a.pages), t < 0 ? t = 1 : t > a.pages && (t = a.pages), a.prev = "prev" in a ? a.prev : "&#x4E0A;&#x4E00;&#x9875;", a.next = "next" in a ? a.next : "&#x4E0B;&#x4E00;&#x9875;";
...
! function() {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function() {
        ...
        T.prototype.systemDate = function(e) { var t = e || new Date; return { year: t.getFullYear(), month: t.getMonth(), date: t.getDate(), hours: e ? e.getHours() : 0, minutes: e ? e.getMinutes() : 0, seconds: e ? e.getSeconds() : 0 } },
    ...
    }, n.render = function(e) { var t = new T(e); return t;
    }, n.getEndDate = function(e, t) { var n = new Date; return n.setFullYear(t || n.getFullYear(), e || n.getMonth() + 1, 1), new Date(n.getTime() - 864e5).getDate() }, window.lay = window.lay || w, e ? (n.ready(), layui.define(function(e) { n.path = layui.cache.dir, e(i, n) })) : "function" == typeof define && define.amd ? define(function() { return n }) : function() { n.ready(), window.laydate = n }()
}();
...
! function(e, t) { "object" == typeof module && "object" == typeof module.exports ? module.exports = e.document ? t(e, !0) : function(e) { if (!e.document) throw new Error("jQuery requires a window with a document"); return t(e) } : t(e) }("undefined" != typeof window ? window : this, function(e, t) {
    ...
    e.getComputedStyle ? (ht = function(t) {
        ...
        var r, i, o, a, s = e.style;
            n = n || ht(e), a = n ? n[t] : void 0, null == a && s && s[t] && (a = s[t]), ft.test(a) && !mt.test(t) && (r = s.left, i = e.runtimeStyle, o = i && i.left, o && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a : a + "" || "auto";
        return n;
    });
    var yt = /alpha\([^)]*\)/i,
        vt = /opacity\s*=\s*([^)]*)/i,
...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
        ...
        F = function(e) {
            ...
            return e = e || {},
                ['<table cellspacing="0" cellpadding="0" border="0" class="layui-table" '
                    ...
                    "<thead>"
                    , "{{# layui.each(d.data.cols, function(i1, item1){ }}", "<tr>", "{{# layui.each(item1, function(i2, item2){ }}"
                    , '{{# if(item2.fixed && item2.fixed !== "right"){ left = true; } }}', '{{# if(item2.fixed === "right"){ right = true; } }}'
                    , function() { return e.fixed && "right" !== e.fixed ? '{{# if(item2.fixed && item2.fixed !== "right"){ }}' : "right" === e.fixed ? '{{# if(item2.fixed === "right"){ }}' : "" }()
                    , '<th data-field="{{ item2.field||i2 }}" {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + t + ' {{# if(item2.unresize){ }}data-unresize="true"{{# } }}>'
                    , '<div class="layui-table-cell laytable-cell-', "{{# if(item2.colspan > 1){ }}", "group", "{{# } else { }}"
    ...
    M.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, text: { none: "无数据" } },
    M.prototype.render = function() {
            ...
            layui.each(t.cols, function(t, i) {
                layui.each(i, function(t, l) {
                    ...
                    if(l){
                        e.initOpts(l),
                            r = l.width || 0,
                        res = void(l.colspan > 1 ||
                            (/\d+%$/.test(r) ? l.width = r = Math.floor(parseFloat(r) / 100 * o) : r || (l.width = r = 0, a++), n += r)
                        );
                    }
                    else{
                        res = void i.splice(t, 1);
                    }
                    return res;
                })
            }),
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            n.contentType && 0 == n.contentType.indexOf("application/json") && (s = JSON.stringify(s)), t.ajax({ type: n.method || "get", url: n.url, contentType: n.contentType, data: s, dataType: "json", headers: n.headers || {}, success: function(t) {
             t[r.statusName] != r.statusCode ? (a.renderForm(),
                     a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t[r.dataName][r.countName]), d(), n.time = (new Date).getTime() - a.startTime + " ms"), i && l.close(i), "function" == typeof n.done && n.done(t, e, t[r.countName]) }, error: function(e, t) { a.layMain.html('<div class="' + f + '">数据接口请求异常</div>'), a.renderForm(), i && l.close(i) } })
        } else if (n.data && n.data.constructor === Array) {
            var u = {},
                h = e * n.limit - n.limit;
            var result = n.data.concat().splice(h, n.limit);
            setDataValue(u,r,result);

                u[r.countName] = n.data.length, a.renderData(u, e, n.data.length), d(), "function" == typeof n.done && n.done(u, e, u[r.countName])
        }
        ...
        var c = this,
            s = c.config;
        var result = getDataValue(e,s.response);
        var u = result || [],
            y = [],
            p = [],
            m = [],
                                ...
                                + function() {
                                        ...
                                        return "checkbox" === n.type ? '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" '
                                            ...
                                            return n[t] ? (a[t] = n[t], n[t] ? "checked" : "") : e[t] ? "checked" : "" 
                                                ...
                                                return "function" == typeof n.templet ? n.templet(e) : i(t(n.templet).html() || String(f)).render(e) }() : f
                                    }(), "</div></td>"].join("");
                            l.push(y),
        ...
        return c.key = s.id || s.index, d.cache[c.key] = u, c.layPage[0 === u.length && 1 == n ? "addClass" : "removeClass"](h), r ? v() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (v(), void(s.page && (s.page = t.extend({ elem: "layui-table-page" + s.index, count: o, limit: s.limit, limits: s.limits || [10, 50, 100], groups: 3, layout: ["prev", "page", "next", "skip", "count", "limit"], prev: '<i class="layui-icon">&#xe603;</i>', next: '<i class="layui-icon">&#xe602;</i>', jump: function(e, t) { t || (c.page = e.curr, s.limit = e.limit, c.pullData(e.curr, c.loading())) } }, s.page), s.page.count = o, a.render(s.page))))
        ...
        } catch (m) { return o.error("Table modules: Did not match to field") } c.sortKey = { field: n, sort: i }, "asc" === i ? r = layui.sort(y, n) : "desc" === i ? r = layui.sort(y, n, !0) : (r = layui.sort(y, d.config.indexName), delete c.sortKey) ,setDataValue(u,h.response,r), c.renderData(u, c.page, c.count, !0), l && layui.event.call(e, s, "sort(" + f + ")", { field: n, type: i })
